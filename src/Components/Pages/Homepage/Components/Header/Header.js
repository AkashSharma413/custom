          ...
          <div className="row">
            <div className="col-sm-12">
              <ul className="list-unstyled d-flex justify-content-between mb-0 text-center">
                <li className="active">
                  <Link to="/">
                    <img src="./header/1.png" alt="" className="img-fluid" width="64" />
                    <p>All</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/2.png" alt="" className="img-fluid" width="64" />
                    <p>Wall Arts</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/3.png" alt="" className="img-fluid" width="64" />
                    <p>Tapestries</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/4.png" alt="" className="img-fluid" width="64" />
                    <p>Rugs & Mats</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/5.png" alt="" className="img-fluid" width="64" />
                    <p>Pillows</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/6.png" alt="" className="img-fluid" width="64" />
                    <p>Curtains</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/7.png" alt="" className="img-fluid" width="64" />
                    <p>Custom Fabric</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/8.png" alt="" className="img-fluid" width="64" />
                    <p>Pet Zone</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/9.png" alt="" className="img-fluid" width="64" />
                    <p>Clothing</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/10.png" alt="" className="img-fluid" width="64" />
                    <p>More</p>
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="./header/11.png" alt="" className="img-fluid" width="64" />
                    <p>Theme</p>
                  </Link>
                </li>
              </ul>
